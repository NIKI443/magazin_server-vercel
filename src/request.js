...
const mockProducts = [
	{
		...
		Изображение:
			'https://avatars.mds.yandex.net/i?id=3c78ffde327b49c364a379f3ce1a069d55f66747-12714748-images-thumbs&n=13',
		Цена: 100,
	},
	{
		ID_товара: 2,
		...
		Изображение:
			'https://main-cdn.sbermegamarket.ru/big2/hlr-system/-17/343/096/479/261/143/100060220989b0.jpg',
		Цена: 150,
	},
]
...
router.post('/cart/add', async (req, res) => {
	try {
		...
		const product = mockProducts.find(p => p.ID_товара === productId)
		if (!product) {
			return res.status(404).json({
				success: false,
				message: 'Товар не найден',
